...
sub options-list {
  ...
  my $list =  "--verbose --completion --clean --color --help --log --list --all -a --show-failed --profile --skip --only --remove --cat --lines --edit --env-cat --env-set --env-edit --env-list --noheader";
